...
export class CoreFacade {
  ...
  verifyOtp(verifyOtpObj: any): void {
    const verifyOtpCommand: VerifyOtpCommand = {
      Otp: verifyOtpObj.otp1 + verifyOtpObj.otp2 + verifyOtpObj.otp3 + verifyOtpObj.otp4 + verifyOtpObj.otp5 + verifyOtpObj.otp6
    };
