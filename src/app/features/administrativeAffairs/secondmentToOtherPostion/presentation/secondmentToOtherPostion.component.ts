...
export default class SecondmentToOtherPostionComponent implements OnInit {
  ...
  onReClassification(): void {
    ...
    if (this.registerFormRequest.valid && this.isAnyFieldFilled()) {
      this.registerFormRequest.controls.SecondmentPositionId.value == '' ||
      this.registerFormRequest.controls.SecondmentPositionId.value == null
        ? this.registerFormRequest.controls.SecondmentPositionId.setValue(employee.positionId)
        : '';
      this.registerFormRequest.controls.basicSalary.value == 0 || this.registerFormRequest.controls.basicSalary.value == null
        ? this.registerFormRequest.controls.basicSalary.setValue(employee.basicSalary)
        : '';
